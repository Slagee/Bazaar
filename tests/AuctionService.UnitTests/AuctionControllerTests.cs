...
public class AuctionControllerTests
{
    ...
    public async Task UpdateAuction_WithUpdateAuctionDto_ReturnsOkResponse()
    {
        ...
        _auctionRepo.Setup(repo => repo.GetAutcionEntityByIdAsync(It.IsAny<Guid>())).ReturnsAsync(auction);
        _auctionRepo.Setup(repo => repo.SaveChangesAsync()).ReturnsAsync(true);
    ...
    public async Task UpdateAuction_WithInvalidGuid_ReturnsNotFound()
    {
        ...
        // act
        var result = await _controller.UpdateAuction(Guid.NewGuid(), updatedAuction);
    ...
    {
        // arrange
        _auctionRepo.Setup(repo => repo.GetAutcionEntityByIdAsync(It.IsAny<Guid>())).ReturnsAsync(value: null);
